...
import 'package:care_circle_new/user/ViewMorePastEvents.dart';
...
class MyPastEvents extends StatefulWidget {
  ...
  @override
  State createState() => _MyPastEventsState();
}
...
class _MyPastEventsState extends State<MyPastEvents> {
  ...
  Future fetchMyEvents() async {
    try {
      ...
      String url = '$urls/ViewMyPastEvents';
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ViewMorePastEvents(eventId: event['id'].toString()),
                                ),
                              );
                            },
