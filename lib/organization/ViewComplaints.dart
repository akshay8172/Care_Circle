...
class _ViewComplaintsState extends State<ViewComplaints> {
  ...
  Future<void> fetchComplaints() async {
    try {
      ...
      String url = '$urls/OrgViewComplaints';
  ...
  Future<void> sendReply(int complaintId, String reply) async {
    try {
      ...
      String url = '$urls/SendReply'; // Replace with your actual endpoint for sending replies
      var response = await http.post(
        Uri.parse(url),
        body: {
                  ...
                  children: [
                    ...
                    complaint['reply'] == 'pending' || complaint['reply'].isEmpty
                      ...
                      child: const Text('Send Reply', style: TextStyle(fontFamily: 'Arial')),
                        ...
                        : Row(
                      children: [
                        Icon(Icons.reply, size: 20, color: Colors.green),
                        SizedBox(width: 8),
                        Text(
                          '${complaint['reply']}',
