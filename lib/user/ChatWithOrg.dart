...
void main() {
  runApp(const ChatWithOrg());
}

class ChatWithOrg extends StatelessWidget {
  const ChatWithOrg({super.key});
...
class _MyChatPageState extends State<MyChatPage> {
  ...
  Future<void> view_message() async {
    ...
    try {
      ...
      String url = '$urls/User_viewchat_Org';
                  ...
                  FloatingActionButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        String url = ip + "/User_sendchat_Org";
